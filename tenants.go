...
func newTenants(rootSDK *Flexprice, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tenants {
	return &Tenants{
		rootSDK:          rootSDK,
...
func (s *Tenants) CreateTenant(ctx context.Context, request components.DtoCreateTenantRequest, opts ...operations.Option) (*operations.CreateTenantResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.CreateTenantResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
