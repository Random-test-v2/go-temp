...
// Generated from OpenAPI doc version 1.0 and generator version 2.844.3
...
// SDK - Flexprice API: Flexprice API provides billing, metering, and subscription management for SaaS and usage-based products. Use it to manage customers, plans, invoices, payments, usage events, and entitlements. Authenticate with an API key in the x-api-key header.
type SDK struct {
	SDKVersion                string
	Addons                    *Addons
...
func New(serverURL string, opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.0.1 2.844.3 1.0 undefined",
		},
		hooks: hooks.New(),
	}
