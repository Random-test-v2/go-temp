...
func newCoupons(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Coupons {
	return &Coupons{
		rootSDK:          rootSDK,
...
func (s *Coupons) CreateCoupon(ctx context.Context, request components.DtoCreateCouponRequest, opts ...operations.Option) (*operations.CreateCouponResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DtoCouponResponse
...
func (s *Coupons) QueryCoupon(ctx context.Context, request components.TypesCouponFilter, opts ...operations.Option) (*operations.QueryCouponResponse, error) {
	...
	res := &operations.QueryCouponResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DtoListCouponsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Coupons) GetCoupon(ctx context.Context, id string, opts ...operations.Option) (*operations.GetCouponResponse, error) {
...
func (s *Coupons) UpdateCoupon(ctx context.Context, id string, body components.DtoUpdateCouponRequest, opts ...operations.Option) (*operations.UpdateCouponResponse, error) {
...
func (s *Coupons) DeleteCoupon(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteCouponResponse, error) {
