...
func newAlerts(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Alerts {
	return &Alerts{
		rootSDK:          rootSDK,
...
func (s *Alerts) QueryAlertLog(ctx context.Context, request components.TypesAlertLogFilter, opts ...operations.Option) (*operations.QueryAlertLogResponse, error) {
	...
	res := &operations.QueryAlertLogResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DtoListAlertLogsResponse
